...
AppState _updateTags(
  ...
  return _updateTagState(
      appState, (tagState) => tagState.copyWith(tags: cloneMap));
}
...
class SetTagsLoading implements Action {
  ...
  AppState updateState(AppState appState) {
    return _updateTagState(
        appState, (tagState) => tagState.copyWith(isLoading: true));
  }
}
...
class SetTagsLoaded implements Action {
  ...
  AppState updateState(AppState appState) {
    return _updateTagState(
        appState, (tagState) => tagState.copyWith(isLoading: false));
  }
}
